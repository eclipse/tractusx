...
import net.catenax.semantics.framework.aas.auth.ApiKeyAuth;
import net.catenax.semantics.framework.aas.auth.HttpBasicAuth;
import net.catenax.semantics.framework.aas.auth.OAuth;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2022-03-04T18:11:20.840352600+01:00[Europe/Berlin]")public class ApiClient {
  ...
  public ApiClient(String[] authNames) {
    ...
    for(String authName : authNames) {
      ...
      if ("CatenaXOpenId".equals(authName)) {
      } else {
