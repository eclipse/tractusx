...
public class ModelType   {
  @JsonProperty("name")
  private ModelTypes name = null;

  public ModelType name(ModelTypes name) {
    this.name = name;
    return this;
  }
  ...
  @Schema(required = true, description = "")
    ...
    @Valid
    public ModelTypes getName() {
    return name;
  }

  public void setName(ModelTypes name) {
    this.name = name;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.name, modelType.name);
  }
